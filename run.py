...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Michael Curry', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:mdcurry1138@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/mikedcurry?tab=repositories'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/michael-curry-7ab92118a/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/MikeDCurry'), 
                ], 
                className='lead'
            )
        )
